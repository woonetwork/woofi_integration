export type Woofi = {
  ...
  "instructions": [
    ...
    {
      "name": "setSuperchargerVaultWhitelist",
      "accounts": [
        {
          "name": "wooconfig",
          "isMut": true,
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "lendingManagerAuthority",
            "type": {
              "vec": "publicKey"
            }
          },
          {
            "name": "superchargerVaultWhitelist",
            "type": {
              "vec": "publicKey"
            }
          },
